-- ----------------------------
-- Table structure for saga_dept
-- ----------------------------
CREATE TABLE `saga_dept`
(
...
-- ----------------------------
-- Table structure for saga_dict
-- ----------------------------
CREATE TABLE `saga_dict`
(
    `id`         bigint(20)                                                    NOT NULL COMMENT '主键',
    `parent_id`  bigint(20)                                                    NULL DEFAULT 0 COMMENT '父主键',
...
-- ----------------------------
-- Table structure for saga_dict_biz
-- ----------------------------
CREATE TABLE `saga_dict_biz`
(
    `id`         bigint(20)                                                    NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Table structure for saga_menu
-- ----------------------------
CREATE TABLE `saga_menu`
(
    `id`         bigint(20)                                                    NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Table structure for saga_notice
-- ----------------------------
CREATE TABLE `saga_notice`
(
    `id`           bigint(20)                                                     NOT NULL COMMENT '主键',
    `tenant_id`    varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT '000000' COMMENT '租户ID',
...
-- ----------------------------
-- Table structure for saga_oss
-- ----------------------------
CREATE TABLE `saga_oss`
(
    `id`          bigint(20)                                                    NOT NULL COMMENT '主键',
    `tenant_id`   varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT '000000' COMMENT '租户ID',
...
-- ----------------------------
-- Table structure for saga_param
-- ----------------------------
CREATE TABLE `saga_param`
(
    `id`          bigint(20)                                                    NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Table structure for saga_region
-- ----------------------------
CREATE TABLE `saga_region`
(
...
-- ----------------------------
-- Table structure for saga_role
-- ----------------------------
CREATE TABLE `saga_role`
(
    `id`         bigint(20)                                                    NOT NULL COMMENT '主键',
    `tenant_id`  varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT '000000' COMMENT '租户ID',
    `parent_id`  bigint(20)                                                    NULL DEFAULT 0 COMMENT '父主键',
...
-- ----------------------------
-- Table structure for saga_role_menu
-- ----------------------------
CREATE TABLE `saga_role_menu`
(
    `id`      bigint(20) NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Table structure for saga_role_scope
-- ----------------------------
CREATE TABLE `saga_role_scope`
(
    `id`             bigint(20) NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Table structure for saga_scope_api
-- ----------------------------
CREATE TABLE `saga_scope_api`
(
    `id`            bigint(20)                                                    NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Table structure for saga_scope_data
-- ----------------------------
CREATE TABLE `saga_scope_data`
(
    `id`            bigint(20)                                                     NOT NULL COMMENT '主键',
    `menu_id`       bigint(20)                                                     NULL DEFAULT NULL COMMENT '菜单主键',
    `resource_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '资源编号',
...
-- ----------------------------
-- Table structure for saga_sms
-- ----------------------------
CREATE TABLE `saga_sms`
(
    `id`          bigint(20)                                                    NOT NULL COMMENT '主键',
    `tenant_id`   varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT '000000' COMMENT '租户ID',
    `category`    int(2)                                                        NULL DEFAULT NULL COMMENT '分类',
...
-- ----------------------------
-- Table structure for saga_tenant
-- ----------------------------
CREATE TABLE `saga_tenant`
(
    `id`             bigint(20)                                                     NOT NULL COMMENT '主键',
    `tenant_id`      varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT '000000' COMMENT '租户ID',
...
-- ----------------------------
-- Table structure for saga_user
-- ----------------------------
CREATE TABLE `saga_user`
(
    `id`          bigint(20)                                                     NOT NULL COMMENT '主键',
    `tenant_id`   varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT '000000' COMMENT '租户ID',
...
-- ----------------------------
-- Table structure for saga_user_app
-- ----------------------------
CREATE TABLE `saga_user_app`
(
    `id`       bigint(20)                                                    NOT NULL COMMENT '主键',
...
-- ----------------------------
-- Table structure for saga_user_dept
-- ----------------------------
CREATE TABLE `saga_user_dept`
(
    `id`      bigint(20) NOT NULL COMMENT '主键',
    `user_id` bigint(20) NULL DEFAULT 0 COMMENT '用户ID',
...
-- ----------------------------
-- Table structure for saga_user_oauth
-- ----------------------------
CREATE TABLE `saga_user_oauth`
(
    `id`        bigint(20)                                                     NOT NULL COMMENT '主键',
    `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '租户ID',
...
-- ----------------------------
-- Table structure for saga_user_other
-- ----------------------------
CREATE TABLE `saga_user_other`
(
    `id`       bigint(20)                                                    NOT NULL COMMENT '主键',
    `user_id`  bigint(20)                                                    NULL DEFAULT 0 COMMENT '用户ID',
    `user_ext` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户拓展信息',
...
-- ----------------------------
-- Table structure for saga_user_web
-- ----------------------------
CREATE TABLE `saga_user_web`
(
    `id`       bigint(20)                                                    NOT NULL COMMENT '主键',
    `user_id`  bigint(20)                                                    NULL DEFAULT 0 COMMENT '用户ID',
    `user_ext` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户拓展信息',
